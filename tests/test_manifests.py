...
class TestManifests(unittest.TestCase):
    ...
    def test_escape_cantaloupe_urls_two(self):
        resp = self.test_app.get("/iiif/3/balagzone_gmail/manifest.json?recache=True")
        self.assertEqual(resp.status_code, 200)
        manifest = resp.json
        #self.assertEqual(99, len(manifest['items']), "This item is missing canvases. It could be the PDF has been selected rather than the zip file of jp2s.")
        if len(manifest['items']) == 1:
            self.assertEqual(manifest['items'][0]['items'][0]['items'][0]['body']['service'][0]['id'] == "https://iiif.archive.org/image/iiif/3/balagzone_gmail%2F%E0%AE%95%E0%AE%A3%E0%AE%95%E0%AF%8D%E0%AE%95%E0%AE%A4%E0%AE%BF%E0%AE%95%E0%AE%BE%E0%AE%B0%E0%AE%AE%E0%AF%8D-%20%E0%AE%AE%E0%AF%81%E0%AE%B4%E0%AF%81%20%E0%AE%A8%E0%AF%82%E0%AE%B2%E0%AF%8D.pdf",True, f"Expected 'https://iiif.archive.org/image/iiif/3/balagzone_gmail%2F%E0%AE%95%E0%AE%A3%E0%AE%95%E0%AF%8D%E0%AE%95%E0%AE%A4%E0%AE%BF%E0%AE%95%E0%AE%BE%E0%AE%B0%E0%AE%AE%E0%AF%8D-%20%E0%AE%AE%E0%AF%81%E0%AE%B4%E0%AF%81%20%E0%AE%A8%E0%AF%82%E0%AE%B2%E0%AF%8D.pdf' but got {manifest['items'][0]['items'][0]['items'][0]['body']['service'][0]['id']}")
        else:
